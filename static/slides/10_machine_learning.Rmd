...
- Learn the basic phases of machine learning
- Learn basic transformations on features
...
The `recipes` package in `tidymodels` outlines approaches to transform data:
