...
- Because it's hard to lecture and monitor chat at the same time, I will ask one of you to be class facilitator and monitor the chat
- This goes towards your class participation grade
...
- I'll divide the class from time to time into breakout rooms for discussion
- I'll ask each room for a summary
- Let's try it
    - Icebreaker: what is your favorite YouTube Channel and why?
...
I will try to answer questions there when I can.
...
Doodle Poll will be sent out with times.
...
If there is some interest in learning more about R, I will do some workshops on more basics.
...
- "Lecture Days"
    - Discussion of Previous Week (1/2 hr)
    - Lectures (1/2 hr)
