---
title: "Introduction to Image Manipulation"
author: "Ted Laderas"
date: "`r Sys.Date()`"
output:
...
- *filtering* - a specific type transformation that uses a pixel value and its neighboring pixels
- *global* transformations - an operation that is applied to all of the pixel values at once.
...
- Noise
- Exposure - dynamic range was too low
- Uneven Illumination

---
# First Do No Harm

- Do as little as possible to images
- Be Transparent
...
.pull-right[
  ![](image/median_filtering.png)
]

---
# Mean vs Median: One ignores the "extreme" values

![](image/median_vs_mean.png)
